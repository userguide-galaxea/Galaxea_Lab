...
class LiftSceneCfg(InteractiveSceneCfg):
    ...
    # camera
    front_camera: CameraCfg = MISSING
    left_wrist_camera: CameraCfg = MISSING
    right_wrist_camera: CameraCfg = MISSING
...
class LiftEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # scene settings
    scene: LiftSceneCfg = LiftSceneCfg(num_envs=8, env_spacing=2.5)
