...
class ReachSceneCfg(InteractiveSceneCfg):
    ...
    table = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(
            pos=(0.65, 0.0, 1.05), rot=(0.70711, 0.0, 0.0, 0.70711)
        ),
    )
...
class CommandsCfg:
    ...
    ee_pose_right = mdp.UniformPoseCommandCfg(
        ...
        ranges=mdp.UniformPoseCommandCfg.Ranges(
            ...
            pos_y=(-0.2, -0.15),
            pos_z=(1.0, 1.5),
            roll=(-0.5 * 3.14, 0.5 * 3.14),
            pitch=MISSING,  # depends on end-effector axis
            yaw=(-0.5 * 3.14, 0.5 * 3.14),
        ),
    )
    ee_pose_left = mdp.UniformPoseCommandCfg(
        ...
        ranges=mdp.UniformPoseCommandCfg.Ranges(
            ...
            pos_y=(0.15, 0.2),
            pos_z=(1.0, 1.5),
            roll=(-0.5 * 3.14, 0.5 * 3.14),  # x-axis
            pitch=MISSING,  # depends on end-effector axis
            yaw=(-0.5 * 3.14, 0.5 * 3.14),  # z-axis
        ),
    )
...
class ReachEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: ReachSceneCfg = ReachSceneCfg(num_envs=4096, env_spacing=1.5)
    # Basic settings
